...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAIN] = LAYOUT_split_3x6_3(
        XXXXXXX, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,       KC_Y,    KC_U,    KC_I,    KC_O,    QK_REP,  XXXXXXX,
        ...
        XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_QUOT, XXXXXXX,
                                   XXXXXXX, OS_SHFT, OS_SYM,     OS_NAV,  KC_SPC,  XXXXXXX
    ),
     ...
     * │   │   │   │   │   │   │   │HOM│PGD│PGU│END│DEL│   │
     * ├───┼───┼───┼───┼───┼───┤   ├───┼───┼───┼───┼───┼───┤
     * │   │SFT│CTL│ALT│GUI│cw │   │ ← │ ↓ │ ↑ │ → │BSP│   │
     * ├───┼───┼───┼───┼───┼───┤   ├───┼───┼───┼───┼───┼───┤
     * │   │   │   │   │   │   │   │PTB│TAB│ESC│NTB│ENT│   │
     * └───┴───┴───┴───┴───┴───┘   └───┴───┴───┴───┴───┴───┘
     */
    [_NAV] = LAYOUT_split_3x6_3(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    RCS(KC_TAB), KC_PGDN, KC_PGUP, C(KC_TAB), KC_DEL,  XXXXXXX,
        XXXXXXX, OS_SHFT, OS_CTRL, OS_ALT,  OS_GUI,  CW_TOGG,    KC_LEFT,     KC_DOWN, KC_UP,   KC_RGHT,   KC_BSPC, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_HOME,     KC_TAB,  KC_ESC,  KC_END ,   KC_ENT,  XXXXXXX,
                                   XXXXXXX, KC_LSFT, _______,    _______, _______, XXXXXXX
    ),
    ...
    [_NUM] = LAYOUT_split_3x6_3(
        ...
        XXXXXXX, OS_SHFT, OS_CTRL, OS_ALT,  OS_GUI,  KC_F11,     KC_F12,  OS_GUI,  OS_ALT,  OS_CTRL, OS_SHFT, XXXXXXX,
