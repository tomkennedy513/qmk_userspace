...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT_split_3x5_2(
        KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_LCBR,    KC_RCBR, KC_AMPR, KC_QUES, KC_PIPE, KC_BSLS,
        KC_GRV,  KC_PLUS, KC_EQL,  KC_COLN, KC_LPRN,    KC_RPRN, OS_GUI,  OS_ALT,  OS_CTRL, OS_SHFT,
        KC_ASTR, KC_SLSH, KC_MINS, KC_UNDS, KC_LBRC,    KC_RBRC, KC_PERC, KC_CIRC, KC_TILD, KC_SCLN,
    ...
    [_NAV] = LAYOUT_split_3x5_2(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    RCS(KC_TAB),    KC_TAB,  KC_ESC,  C(KC_TAB),    KC_ENT,
                                   _______, _______,    _______, _______
    ),
